        ...
        <form method="post">
            <div class="box flex-container">
                <label class="plan flex-container" for="best_value">
                    ...
                    <h3 class="price"><sup class="currency">KM</sup>3.49<span style="font-size: 14px;font-weight: 500">/mo</span>
                    </h3>
                    <p class="saving">Save 70%</p>
                    <p class="value">Get the best value — save <br>70%</p>
                    <p class="billing"><strike style="color: #f64f64">KM 430.20</strike> KM 125.64 billed every 3<br>years
                    </p>
                </label>
                <label class="plan flex-container" for="loyal_plan">
                    ...
                    <h3 class="price"><sup class="currency">KM</sup>4.99<span style="font-size: 14px;font-weight: 500">/mo</span>
                    </h3>
                    <p class="saving">Save 58%</p>
                    <p class="value">Our 2nd best offer. <br>730 days of Pick & Fix jobs.</p>
                    <p class="billing"><strike style="color: #f64f64">KM 286.80</strike> KM 119.76 billed every 2<br>years
                    </p>
                </label>
                <label class="plan flex-container" for="basic_plan">
                    ...
                    <h3 class="price"><sup class="currency">KM</sup>6.99<span style="font-size: 14px;font-weight: 500">/mo</span>
                    </h3>
                ...
                <label class="plan flex-container" for="trial_plan">
                    ...
                    <h3 class="price"><sup class="currency">KM</sup>11.95<span style="font-size: 14px;font-weight: 500">/mo</span>
                    </h3>
