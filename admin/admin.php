...
<main class="center">
    ...
    <div class="flex-container">
        ...
        <div>
            ...
            <div class="flex-container">
                <a href="services/services.php" id="stay"><i class="fa fa-angle-right" aria-hidden="true"></i>Services</a>
                <div>
                    <ul>
            ...
            <div class="flex-container">
                <a href="work_offers/work_offers.php" id="stay"><i class="fa fa-angle-right" aria-hidden="true"></i>Work Offers</a>
                <div>
                    <ul>
                        <li>List of all professionals with displayed number of accepted, rejected, total requests, general
                            rating and the percentage of times being rated by customers for completed jobs</li>
            ...
            <div class="flex-container">
                ...
                <div>
                    <ul>
                        ...
                        <li>List of professionals who requested services of another professional along with counted number of times</li>
            ...
            <div class="flex-container">
                <a href="payments/payments.php" id="stay"><i class="fa fa-angle-right" aria-hidden="true"></i>Payments</a>
                <div>
                    <ul>
                        <li>Number of professionals that continued their payment after the 1st payment plan expiration</li>
                        ...
                        <li>Minimum, maximum, average and total amount billed per service in a given period
                            along with the number of completed jobs</li>
                        <li>Minimum, maximum, average and total amount billed per city in a given period
                            along with the number of completed jobs</li>
                        <li>List of professionals and the mount of money they paid for their usage fees of the platform in a given period</li>
                        <li>List of regular users and the amount of money they spent on the platform in a given period </li>
                    </ul>
                </div>
            </div>
        </div>
